...
import { Controller, FieldErrors, HttpStatusCodeLiteral, TsoaResponse, TsoaRoute, ValidateError, ValidationService } from '@tsoa/runtime/dist';
import * as express from 'express';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { CustomersController } from './../src/customers/customersController';

// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
type ExRouter = typeof express.Router;
...
export function RegisterRoutes(app: ExRouter) {
  // ###########################################################################################################
  ...
  app.get(
    ...
    function CustomersController_getCustomer(request: any, response: any, next: any) {
      const args = {
  ...
  app.post(
    ...
    function CustomersController_createCustomer(request: any, response: any, next: any) {
      const args = {
